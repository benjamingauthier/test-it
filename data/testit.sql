...
-- -----------------------------------------------------
-- Table `test-it`.`groups`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-it`.`groups` (
...
-- -----------------------------------------------------
-- Table `test-it`.`versions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-it`.`versions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `description` VARCHAR(255) NULL,
  `created` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `test-it`.`check_ups` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_check_ups_version1_idx` (`version_id` ASC),
  CONSTRAINT `fk_check_ups_version1`
    FOREIGN KEY (`version_id`)
    REFERENCES `test-it`.`versions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `test-it`.`users_has_check_ups` (
  ...
  PRIMARY KEY (`users_id`, `check_ups_id`),
  INDEX `fk_users_has_check_ups_check_ups1_idx` (`check_ups_id` ASC),
  ...
  CONSTRAINT `fk_users_has_check_ups_check_ups1`
    FOREIGN KEY (`check_ups_id`)
    REFERENCES `test-it`.`check_ups` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
